...
urlpatterns = [
    ...
    path('remove_employee/<int:emp_id>/', views.remove_employee, name='remove_employee'),
     path('view_all/', views.filter_employee_details, name='filter_employee_details'),
    # path('filter_employee_details/', views.filter_employee_details, name='filter_employee_details'),
